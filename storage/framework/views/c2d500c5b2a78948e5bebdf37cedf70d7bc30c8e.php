...
} elseif ($_instance->childHasBeenRendered('qJFRePp')) {
    $componentId = $_instance->getRenderedChildComponentId('qJFRePp');
    $componentTag = $_instance->getRenderedChildComponentTagName('qJFRePp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qJFRePp');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('qJFRePp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\workspace\microweber\storage\framework\views/928c7bfab9e40140a3a59c2d4bdddbabf41b03c2.blade.php ENDPATH**/ ?>