(function () {
    ...
    mw.settings = {
        ...
        template_url: 'http://localhost:8000/userfiles/templates/bootstrap5/',
        modules_url: 'http://localhost:8000/userfiles/modules/',
        includes_url: 'http://localhost:8000/userfiles/modules/microweber/',
        upload_url: 'http://localhost:8000/api/upload/',
        api_url: 'http://localhost:8000/api/',
        libs_url: 'http://localhost:8000/userfiles/modules/microweber/api/libs/',
        api_html: 'http://localhost:8000/api_html/',
...
mw.askusertostay = false;
  ...
  mw.require = function(url, inHead, key) {
    ...
    var t = url.split('.').pop();
    url = url.contains('//') ? url : (t !== "css" ? "http://localhost:8000/userfiles/modules/microweber/api/" + url  :  "http://localhost:8000/userfiles/modules/microweber/css/" + url);
...
mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/jquery.js");



mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/tools.js");
mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/tools/cookie.js");



mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/forms.js");

mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/url.js");

mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/events.js");

//mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/upgrades.js");
mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/session.js");

mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/shop.js");

mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/common.js");

mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/components.js");

mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/dialog.js");
mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/instruments.js");
mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/forms.js");
mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/fonts.js");

//mw.required.push("http://localhost:8000/userfiles/modules/microweber/api/content.js");
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/base64.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/checkbox.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/colorpicker.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/common-extend.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/common.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/dialog.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/domhelpers.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/dropdown.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/editor.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/element.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/elementedit.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/external.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/extradata-form.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/fullscreen.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/gallery.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/helpers.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/iframe-tools.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/images.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/jquery.tools.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/loading.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/loops.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/modules-dialogs.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/native-notification.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/notification.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/objects.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/responsive.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/select.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/spinner.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/storage.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/system-dialogs.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/tabs.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/tooltip.js');
...
mw.required.push('http://localhost:8000/userfiles/modules/microweber/api/tools/uiaccordion.js');
